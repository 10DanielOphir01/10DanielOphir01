...
- 🎓 **2nd Year EE** at Afeka College of Engineering, tracking **Communications & Hardware Design**
- 🏠 Homelab obsessive — self-hosted services, local AI inference, and full home automation
- 📟 ESP32 tinkerer — custom firmware, sensors, TFT displays, GPS, and LED controllers
- 📡 Drawn to the intersection of **signals, embedded code, and the physical world**
- 🛠️ If there's hardware involved, I'll probably try to talk to it over UART first
...
![ESPHome](https://img.shields.io/badge/ESPHome-000000?style=for-the-badge&logo=esphome&logoColor=41BDF5)
...
<div align="center">
  <sub><i>⚡ "Build it. Break it. Understand it. Rebuild it better." ⚡</i></sub>
</div>

<br/>

<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:00b4d8,50:1a3a5c,100:0d1117&height=120&section=footer" width="100%"/>
</div>
